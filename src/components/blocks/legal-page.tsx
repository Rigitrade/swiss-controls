...
const mdxComponents = {
  h2: ({ children, ...props }: ComponentPropsWithoutRef<"h2">) => (
    <h2
      className="mt-16 mb-6 border-b border-line pb-4 text-[1.375rem] font-semibold leading-tight tracking-[-0.01em] text-ink first:mt-0"
      {...props}
    >
      {children}
    </h2>
  ...
  h3: ({ children, ...props }: ComponentPropsWithoutRef<"h3">) => (
    <h3
      className="mt-10 mb-3 text-[1.0625rem] font-semibold leading-snug text-ink"
      {...props}
    >
      {children}
    </h3>
