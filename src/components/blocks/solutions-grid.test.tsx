...
const content = {
  ...
  items: [
    { slug: "operational-modernization", icon: "RefreshCw", title: "Operational Modernization & Asset Lifecycle", summary: "…", image: "/img/solutions/operational-modernization.jpg" },
    { slug: "energy-transition", icon: "Zap", title: "Energy Transition & Infrastructure Reliability", summary: "…", image: "/img/solutions/energy-transition.jpg" },
  ],
}
